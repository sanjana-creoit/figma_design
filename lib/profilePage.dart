...
class ProfilePage extends GetView<ProfilePageController> {
  String? contact;
  ProfilePage({super.key, this.contact});

  final controller = Get.put(ProfilePageController());

  @override
  Widget build(BuildContext context) {
    controller.isFromChat = Get.arguments["isFromChat"];
    return Scaffold(
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
        child: Obx(() {
          return Column(
            children: [
              controller.isFromChat == true ? Image.asset(controller.imagePath.value, height: 120,
                width: 120,
                fit: BoxFit.contain,) :
